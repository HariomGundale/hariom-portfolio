...
export default function ContactPage() {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      url: "https://github.com/HariomGundale",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/hariom-gundale-28448332b/",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
      name: "Email",
      url: "mailto:hariomgundale21@gmail.com",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-[#0b0d12] text-white flex items-center py-6 sm:py-10 px-4 sm:px-8 md:pl-16 lg:pl-24">
      ...
      <div className="absolute top-[-200px] right-[-200px] w-[500px] h-[500px] bg-purple-600/20 blur-[120px] rounded-full" />
      ...
      <div className="relative max-w-4xl mx-auto w-full">
        ...
        <motion.div
          ...
          className="mx-auto max-w-xl rounded-xl border border-purple-300 bg-white dark:bg-zinc-900 p-8 shadow-lg"
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-gray-300 dark:border-gray-700 bg-transparent px-4 py-2 text-gray-800 dark:text-white focus:outline-none focus:border-purple-500"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-md bg-purple-500 py-3 text-white font-medium hover:bg-purple-700 transition disabled:opacity-50"
            >
